...
function controller($rootScope, $scope, $http, errHandlerSvc, toastr) {
    ...
    vm.search = function () {
        $http.get(`admin-module/api/roles/?criteria=${vm.data.criteria}&page=${vm.data.page}&pageSize=${vm.data.pageSize}`)
            .then((resp) => {
...
app.component('rolesComponent', {
    controller: controller,
    templateUrl: '/admin/roles/index?handler=indexpartial'
});