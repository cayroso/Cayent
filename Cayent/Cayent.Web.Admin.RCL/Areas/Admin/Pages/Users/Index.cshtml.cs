...
namespace Cayent.Web.Admin.RCL.Areas.Admin.Pages.Users
{
    //[Authorize]
    public class IndexModel : PageModel
    {
        ...
        {
            //var cmd1 = new CreateAppCommand(string.Empty, "admin.useers " + Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), string.Empty, 1);
