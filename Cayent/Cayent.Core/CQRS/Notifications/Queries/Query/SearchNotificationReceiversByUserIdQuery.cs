...
{
    public sealed class SearchNotificationReceiversByUserIdQuery : Query<PaginatedNotificationReceiverDto>
    {
        public SearchNotificationReceiversByUserIdQuery(string correlationId, string userId, 
